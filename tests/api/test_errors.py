...
from invenio_app_ils.errors import NotImplementedConfigruationError, \
...
def test_not_implemented(app):
    """Test NotImplementedConfigruationError."""
    ...
    with pytest.raises(NotImplementedConfigruationError) as ex:
        raise NotImplementedConfigruationError(config_variable="CONFIG_VAR")
    assert ex.value.code == NotImplementedConfigruationError.code
